...
<ul>
<li class="vote_abs_up"><a href="#"{if $logged} class="abs_qvoteup" data-abs_q="{$question['id_absquestion']|cleanHtml}"{else} data-abs_cq_nw="postvoted" class="abs_qvotenup"{/if}><img src="/img/cms/icone/sopra.svg"></i></a></li>
...
<li class="vote_abs_down"><a href="#"{if $logged} class="abs_qvotedown" data-abs_q="{$question['id_absquestion']|cleanHtml}"{else} data-abs_cq_nw="postvoted" class="abs_qvotenup"{/if}><img src="/img/cms/icone/sotto.svg"></i></a></li>
</ul>
</div>
